...
pub fn tab_view() -> impl IntoView {
    ...
    v_stack((
        h_stack((
            button("add tab")
                ...
                .style(|s| s.apply(dark_button_class().apply_class(DarkButtonClass))),
            button("remove tab")
                .action(move || {
                    tab_action.update(|a| {
                        *a = Action::Remove;
    ...
    .container()
    .style(|s| s.size_full().padding(10.).background(D_BG_DARK))
}
    ...
    stack((
        ...
        stack((
            ...
            .apply_box_shadow(BoxShadow::new()
                // .color(D_BORDER.multiply_alpha(0.55))
                .top_offset(-13.)
                .bottom_offset(0.4)
                .right_offset(-4.)
                .left_offset(-4.)
...
fn tab_side_item(tab: TabContent, act_tab: RwSignal<Option<usize>>) -> impl IntoView {
    text(format!("{} {}", tab.name, tab.idx)).style(move |s| {
        s.items_center()
            ...
            .apply(dark_button_class().apply_class(DarkButtonClass))
            .border_radius(8.)
...
style_class!(DarkButtonClass);
style_class!(DarkListItemClass);

pub fn dark_theme() -> Style {
    Style::new()
        .class(DarkButtonClass, |s| dark_button_class())
        .class(DarkListItemClass, |s| dark_button_class())
}

fn dark_button_class() -> Style {
    Style::new()
        .class(DarkButtonClass, |s| s
            .selectable(false)
            .transition_background(Transition::linear(30.millis()))
            .background(D_BG_LIGHT)
            .color(D_TEXT_MUTED)
            .border(0.)
            .border_top(0.5)
            // .border_top(0.5)
            // .border_color(D_BORDER)
            .border_top_color(D_BORDER)
            .border_radius(6.)
            .padding_vert(7.px())
            // .box_shadow_color(D_BG_DARK)
            .box_shadow_top_offset(-15.)
            ...
            .hover(|s| s
                ...
                .box_shadow_blur(4.)
                .apply_box_shadow(BoxShadow::new()
                    // .color(D_BORDER.multiply_alpha(0.8))
                    .top_offset(-13.)
                    .bottom_offset(0.4)
                    .right_offset(-4.)
                    .left_offset(-4.)
            ...
            .focus(|s| s
                ...
                .hover(|s| s
                    ...
                    .border_color(D_BORDER)
                    .border_top_color(D_HIGHLIGHT)
                    // .box_shadow_color(D_BORDER.multiply_alpha(0.55))
                    .box_shadow_top_offset(-15.)
                    .box_shadow_bottom_offset(3.)
                    .box_shadow_right_offset(-6.)
                    .box_shadow_left_offset(-6.)
            ...
            .disabled(|s| s
                ...
                .box_shadow_blur(2.)
                .box_shadow_v_offset(1.)
                .box_shadow_color(D_TEXT)
            )
    )
}


fn dark_item_class() -> Style {
    Style::new()
        .class(DarkListItemClass, |s| s
            .selectable(false)
            // .transition_background(Transition::linear(30.millis()))
            .background(D_BG_LIGHT)
            .color(D_TEXT_MUTED)
            .border(1.)
            .border_color(D_BG_LIGHT)
            .border_radius(5.)
            .padding_vert(6.px())
            .box_shadow_color(D_BG_DARK)
            .box_shadow_top_offset(-15.)
...
const D_BG_DARK: Color = hsl([60., 3., 5.]);
const D_BG: Color = hsl([60., 3., 10.]);
const D_BG_LIGHT: Color = hsl([60., 3., 15.]);

const D_BORDER: Color = hsl([60., 3., 30.]);
const D_HIGHLIGHT: Color = hsl([60., 3., 40.]);

const D_TEXT: Color = hsl([60., 3., 95.]);
const D_TEXT_MUTED: Color = hsl([60., 3., 70.]);
